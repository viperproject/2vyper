...
#:: UnexpectedOutput(carbon)(check.violated:assertion.false, 33)
...
def foo(a: int128):
    ...
    for i in range(42):
        ...
        #:: UnexpectedOutput(carbon)(loop.invariant.not.preserved:assertion.false, 33)
    ...
    for i in range(100, 200):
        ...
        #:: UnexpectedOutput(carbon)(loop.invariant.not.established:assertion.false, 33) | UnexpectedOutput(carbon)(loop.invariant.not.preserved:assertion.false, 33)
