...
NOT_ALLOWED_IN_INVARIANT = [*NOT_ALLOWED_IN_SPEC, SUCCESS, RESULT, ISSUED, INDEPENDENT, REORDER_INDEPENDENT, EVENT]
...
NOT_ALLOWED_IN_TRANSITIVE_POSTCONDITION = [*NOT_ALLOWED_IN_INVARIANT, INDEPENDENT, REORDER_INDEPENDENT, ACCESSIBLE]
NOT_ALLOWED_IN_GHOST_FUNCTION = [*NOT_ALLOWED_IN_SPEC, SUCCESS, RESULT, STORAGE, OLD, ISSUED, ACCESSIBLE, INDEPENDENT, REORDER_INDEPENDENT]
