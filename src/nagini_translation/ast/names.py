...
NOT_ALLOWED_IN_INVARIANT = [*NOT_ALLOWED_IN_SPEC, SUCCESS, RESULT, EVENT]
NOT_ALLOWED_IN_CHECK = [*NOT_ALLOWED_IN_SPEC, SUCCESS, RESULT]
NOT_ALLOWED_IN_POSTCONDITION = [*NOT_ALLOWED_IN_SPEC, EVENT]
