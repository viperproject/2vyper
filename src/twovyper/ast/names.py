...
NOT_ALLOWED_IN_INVARIANT = [*NOT_ALLOWED_IN_SPEC, SUCCESS, RESULT, ISSUED, BLOCKHASH, INDEPENDENT,
                            REORDER_INDEPENDENT, EVENT, PUBLIC_OLD]
NOT_ALLOWED_IN_LOOP_INVARIANT = [*NOT_ALLOWED_IN_SPEC, ACCESSIBLE, SUCCESS, RESULT, ACCESSIBLE, OLD,
                                 INDEPENDENT, REORDER_INDEPENDENT]
NOT_ALLOWED_IN_CHECK = [*NOT_ALLOWED_IN_SPEC, INDEPENDENT, ACCESSIBLE, RESULT, PUBLIC_OLD]
NOT_ALLOWED_IN_POSTCONDITION = [*NOT_ALLOWED_IN_SPEC, ACCESSIBLE]
NOT_ALLOWED_IN_PRECONDITION = [*NOT_ALLOWED_IN_SPEC, ACCESSIBLE, SUCCESS, RESULT, ACCESSIBLE, OLD,
                               INDEPENDENT, REORDER_INDEPENDENT]
NOT_ALLOWED_IN_TRANSITIVE_POSTCONDITION = [*NOT_ALLOWED_IN_SPEC, SUCCESS, RESULT, INDEPENDENT, REORDER_INDEPENDENT,
                                           EVENT, ACCESSIBLE, PUBLIC_OLD]
...
NOT_ALLOWED_IN_GHOST_FUNCTION = [*NOT_ALLOWED_IN_SPEC, SUCCESS, RESULT, STORAGE, OLD, PUBLIC_OLD, ISSUED, BLOCKHASH,
                                 LOCKED, SENT, RECEIVED, ACCESSIBLE, INDEPENDENT, REORDER_INDEPENDENT]
