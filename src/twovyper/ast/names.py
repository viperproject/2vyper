...
GHOST_STATEMENTS = [REALLOCATE, FOREACH, OFFER, REVOKE, EXCHANGE, CREATE, DESTROY]
QUANTIFIED_GHOST_STATEMENTS = [OFFER, REVOKE, CREATE, DESTROY]
ALLOCATION_FUNCTIONS = [ALLOCATED, OFFERED, *GHOST_STATEMENTS]
