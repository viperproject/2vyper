...
NOT_ALLOWED_IN_PRECONDITION = [*NOT_ALLOWED_IN_SPEC, ACCESSIBLE, SUCCESS, RESULT, ACCESSIBLE,
...
NOT_ALLOWED_IN_GHOST_FUNCTION = [*NOT_ALLOWED_IN_SPEC, SUCCESS, RESULT, STORAGE, OLD, ISSUED, BLOCKHASH, LOCKED, SENT,
                                 RECEIVED, ACCESSIBLE, INDEPENDENT, REORDER_INDEPENDENT]
