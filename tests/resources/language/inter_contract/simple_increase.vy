...
# Does not alter mappings of other simple_increase contracts
#@ always ensures: forall({a: address, b: address}, {mapping(a)[b]}, (a != self and implements(a, simple_increase)) ==> old(mapping(a)[b]) == mapping(a)[b])
